...
export const defaultAlgorithmSettings = {
  ...
  lineBrushSpill: 28,
  mirrorFoldSide: 'both' as const,
  mirrorFoldAxis: 'stroke' as const,
  mirrorFoldOffset: 8,
  mirrorFoldMix: 0.86,
  mirrorFoldRepetitions: 1,
  mirrorFoldRgbSlip: 3,
  ...
  rasterLoomDirection: 'perpendicular' as const,
  rasterLoomGap: 1,
  rasterLoomRgbSlip: 3,
  rasterLoomAlternation: 1,
  rasterLoomEdgeSoftness: 0.28,
  rasterLoomMix: 0.9,
  rasterLoomFallbackAngle: 0,
  contourCrawlEdgeThreshold: 54,
  contourCrawlLength: 44,
  contourCrawlRepeatCount: 4,
  contourCrawlDecay: 0.68,
  contourCrawlLineWidth: 2,
  contourCrawlRgbSplit: 3,
  contourCrawlSideDrift: 4,
